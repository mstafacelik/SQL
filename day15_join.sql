/*============================== JOIN ISLEMLERI ===============================
    ...
    Union,Union All Operatorleri "ayni tablodaki" select ile gelen farkli sutunlari 
...
select sirketler1.sirket_id,
		sirketler1.sirket_isim,
        siparisler.siparis_id,
        siparisler.siparis_tarihi
from sirketler1 inner join siparisler
on sirketler1.sirket_id=siparisler.sirket_id;
...
select  sirketler1.sirket_id,
		...
		siparisler.siparis_id,
        siparisler.siparis_tarihi
from sirketler1 left join siparisler
on sirketler1.sirket_id=siparisler.sirket_id;
...
select  sirketler1.sirket_id,
		...
		siparisler.siparis_id,
        siparisler.siparis_tarihi
from siparisler right join sirketler1
on sirketler1.sirket_id=siparisler.sirket_id;
...
select siparisler.siparis_id, 
	   siparisler.siparis_tarihi,
       sirketler1.sirket_isim
from sirketler1 right join  siparisler
on siparisler.sirket_id=sirketler1.sirket_id;
...
/* -----------------------------------------------------------------------------
  ORNEK4: sirketler ve siparisler adindaki tablolarda yer alan sirket_isim, 
  siparis_id ve siparis_tarihleri listeleyen bir sorgu yaziniz.
------------------------------------------------------------------------------*/
...
select  sirketler1.sirket_id, 
        ...
        siparisler.siparis_tarihi
from sirketler1 left join siparisler
on sirketler1.sirket_id=siparisler.siparis_id
UNION
...
order by bolum_isim, personel_isim;        -- Eger burada personel_isim i kaldirirsak bolumleri ayni olanlari 
										   -- "kayit sirasina gore" getirir.
                                           

/* -----------------------------------------------------------------------------
  ORNEK2: SATIS,ISLETME ve DEPO bolumlerinde calisan personelin isimlerini, bolumlerini isim sirali olarak listeleyiniz. 
...
on bolumler.bolum_id=calisanlar.bolum_id
where bolum_isim in ('MUHASEBE','SATIS','DEPO')
